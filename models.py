...
#######################################End of evaluating the model#################################################

# #######################################Transfer Learning with AlexNet############################################

# # Debugging: Check the shape of images
...
# # Freeze all parameters in the features part (convolutional layers)
# for param in alexnet.features.parameters():
#     param.requires_grad = False

# # Get the number of features in the last layer
# num_features = alexnet.classifier[6].in_features  # This is 4096 for AlexNet

# # Replace the final layer with a new one that outputs your number of classes
# alexnet.classifier[6] = nn.Linear(num_features, num_classes)  # num_classes = 26 for braille letters

# # Define transformations for the images for AlexNet
# # Note: AlexNet expects 224x224 images
# transform = transforms.Compose([
#     transforms.Resize(256),
#     transforms.CenterCrop(224),  # AlexNet expects 224x224 images
#     transforms.ToTensor(),
...
# # Update your dataset with the new transform
...
# print("Dataset updated with new transform\n")
...
#     learning_rate=0.001,
#     num_epochs=50,
#     checkpoint_dir='braille_alexnet_checkpoints'
# )
...
# #######################################End of Transfer Learning with AlexNet############################################
